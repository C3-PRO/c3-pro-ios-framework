...
public class DataQueue: Server
{
	...
	// MARK: - URL Session
	public override func performPreparedRequest<R : FHIRServerRequestHandler>(request: NSMutableURLRequest, handler: R, callback: ((response: FHIRServerResponse) -> Void)) {
